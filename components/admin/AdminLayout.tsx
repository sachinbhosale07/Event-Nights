    ...
    <div className="min-h-screen bg-background flex">
      ...
      <aside className="w-64 bg-surface border-r border-white/5 flex-col fixed inset-y-0 z-50 hidden md:flex">
        <div className="h-16 flex items-center px-6 border-b border-white/5">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-purple-600 to-pink-600 flex items-center justify-center mr-3">
      ...
      <main className="flex-1 md:ml-64 flex flex-col min-h-screen">
        ...
        <header className="h-16 bg-background/80 backdrop-blur-xl border-b border-white/5 sticky top-0 z-40 px-4 md:px-8 flex items-center justify-between">
          <div className="flex items-center gap-4">
             <button className="md:hidden p-2 text-gray-400 hover:bg-white/5 rounded-lg">
                <Menu size={20} />
             </button>
             <div className="relative hidden sm:block">
                ...
                <input 
                  type="text" 
                  placeholder="Search..." 
                  className="bg-surface border border-white/10 rounded-full pl-10 pr-4 py-1.5 text-sm text-white focus:border-purple-500 focus:outline-none w-64"
                />
             </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3 pl-4 border-l border-white/10">
              ...
              <div className="w-9 h-9 rounded-full bg-gray-700 border border-white/10 overflow-hidden flex items-center justify-center">
